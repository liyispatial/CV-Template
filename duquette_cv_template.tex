...
% https://github.com/NicDuquette/CV-Template
% 
...
\begin{document}
	...
	% Note:
	% As is done throughout the document, I use the "datetabbing" environment I defined
...
\heading{Teaching}
	...
	% Note:
	% One of the nice things about using LaTeX to make a CV is that I can add all
	% sorts of verbose notes to myself in comments that won't be compiled to
	% the PDF output. (You can do this with comment bubbles in Word too, but
	% getting a PDF out without them needs to be done correctly every time.)
	% Here, I keep track of the terms I've taught all my courses in comments.
\begin{datetabbing}
...
* -- Scheduled
	...
	% Sometimes I use \clearpage to manually prevent headings from
	% being orphaned. I'm sure there's a good way to automate this but
	% I have been too lazy to figure it out.
\clearpage
\heading{Professional Service}


	% I use comments here to keep track of exactly what I did for each service obligation.
	% That includes more detailed tallies of which papers I've reviewed for each 
	% journal when (which is why the examples I've put here, on this public
	% template, are entirely fictional).
\begin{datetabbing}	
...
\>	\>	\textit{American Economic Journal}											\\[\wrapgap]
	% 1. That paper about snails -- first round Oct 2019
	%				-- Second round May 2020
	%				-- Third round Sep 2020
	% 2. That paper about slugs -- first round Jan 2020
...
\>	\>	Doctoral Committees	 ($\times$4)						\>		2019--2021	\'	\\[\dategap]
